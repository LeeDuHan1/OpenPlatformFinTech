...
public class APICallPageWithdrawTransferFragment extends BaseFragment {
    ...
    EditText etPrintContent; // 출금계좌인자내역
    EditText etTranDtime; // 거래일시
    EditText etTranAmt; // 거래금액
    EditText etCmsNo; // CMS번호
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        etCmsNo = (EditText)view.findViewById(R.id.etCmsNo);
    ...
    private void trasnferWithdraw(){
        ...
        params.put("print_content", etPrintContent.getText().toString());
        params.put("tran_dtime", etTranDtime.getText().toString());
        params.put("tran_amt", etTranAmt.getText().toString());
        params.put("cms_no", etCmsNo.getText().toString());
    ...
    private void saveInputValues() {
        ...
        editor.putString(NS + "cms_no" + es, etCmsNo.getText().toString());
        editor.apply();
    }
    ...
    private void loadInputValues(){
        ...
        etCmsNo.setText(StringUtil.getPropString(NS + "cms_no" + es));
    }
